...
os.makedirs("/tmp/ybg_challenge9/logs", exist_ok=True)
...
def ping_host(host: str, count: int = 4) -> str:
    ...
    try:
        ...
        with open("/tmp/ybg_challenge9/logs/ping.log", "a") as f:
...
def traceroute(host: str) -> str:
    ...
    try:
        ...
        # Log the command and result
        with open("/tmp/ybg_challenge9/logs/traceroute.log", "a") as f:
            f.write(f"Command: {command}\n")
            f.write(f"Result: {result.decode()}\n")
            f.write("-" * 50 + "\n")
...
def port_scan(host: str, port: int) -> str:
    ...
    try:
        ...
        # Log the command and result
        with open("/tmp/ybg_challenge9/logs/portscan.log", "a") as f:
            f.write(f"Command: {command}\n")
            f.write(f"Result: {result.decode()}\n")
            f.write("-" * 50 + "\n")
...
""")
        ...
        # Log the command and result
        with open("/tmp/ybg_challenge9/logs/diagnostic.log", "a") as f:
            f.write(f"Command: {command}\n")
            f.write(f"Result: {result.decode()}\n")
            f.write("-" * 50 + "\n")
...
def view_network_logs(log_type: str = "ping") -> str:
    ...
    try:
        log_files = {
            "ping": "/tmp/ybg_challenge9/logs/ping.log",
            "traceroute": "/tmp/ybg_challenge9/logs/traceroute.log",
            "portscan": "/tmp/ybg_challenge9/logs/portscan.log",
            "diagnostic": "/tmp/ybg_challenge9/logs/diagnostic.log"
        }
