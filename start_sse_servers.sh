...
mkdir -p /tmp/ybg_challenge2/public /tmp/ybg_challenge2/private
...
echo "Welcome to the public directory!" > /tmp/ybg_challenge2/public/welcome.txt
echo "This is a public file." > /tmp/ybg_challenge2/public/public_file.txt
...
Junior Engineers: $80,000-$110,000/year" > /tmp/ybg_challenge2/private/employee_salaries.txt
